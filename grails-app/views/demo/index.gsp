...
<html>
  ...
  <body>
    ...
    <g:select name="charts" from="${DemoCharts.values()}" optionValue="display"
            onChange="new Ajax.Request('${request.contextPath}/demo/'+\$('charts').value,{asynchronous:true,evalScripts:true,onSuccess:function(e){uploadChart('demo-chart',e.responseText)}});"/>
    <br/><br/>
